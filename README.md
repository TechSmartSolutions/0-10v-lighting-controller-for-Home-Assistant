...
This guide provides information to build a <a href="https://www.home-assistant.io/">Home Assistant</a> compatible light dimmer that will work with most <a href="https://led.meanwell.com/productSeries.aspx">Meanwell LED drivers (aka LED power supplies or ballasts)</a> using just a few electronic parts.  This will also work with LED drivers compatible with 3-in-1 dimming and PWM dimming.  I think this can also be modified to work with 0-10v DC dimming (additive voltage dimming or analog dimming) by adding a 10v power source using an additional power source, but I haven't tried it.  Feel free to reach out to me if you have any questions about that.
