...
This little connector will give us a port to plug the power adapter into. There are a few reasons for chosing a connector like this.  1) If the power cord gets pulled on very hard, the power cable will simply disconnect from the controller, the internal wiring of the controller will not be affected. This makes it safer for you, as well as protects the controller from damage.  2) You must power off the controller (and drivers) anytime you are connecting or disconnecting the LED Drivers to the Dimming controller.  Having a connector like this allows you to easily power off the controller without having to unplug the power adapter from the wall.  
