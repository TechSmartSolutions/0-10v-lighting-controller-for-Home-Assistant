...
## Intro
This comprehensive guide is designed to help you create a cost-effective light dimming solution that integrates seamlessly with Home Assistant. With this solution, you'll be able to control most <a href="https://led.meanwell.com/productSeries.aspx">Meanwell LED drivers</a> (power supplies or ballasts) using <a href="#parts-needed">a few electronic components</a>. Moreover, the information provided here is also applicable to other LED drivers that use PWM dimming, so long as the driver provides source current on the dimming circuit. You may also be able to modify the setup to work as a 0-10v DC additive dimmer, which is more widely used for LED Drivers.
...
<img src="/images/led-dimmer-circuit-diagram-TLC59711.png">  
