...
- ESP32, ESP8266, Arduino, Raspberry Pi or other device with SPI pins (this project is using a cheap [Wemos D1 Mini ESP8266](https://wiki.wemos.cc/products:d1:d1_mini))
