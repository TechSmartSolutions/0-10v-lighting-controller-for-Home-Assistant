...
## Background
Controlling LED grow and aquarium lights is typically done using dimming knobs, controllers, or proprietary solutions from commercial manufacturers or resellers. However, by building your own dimming controller, you can increase the level of functionality, automation, and customization. With Home Assistant, the possibilities are virtually limitless. You can create custom lighting profiles for different stages of growth or times of day, adjust light output based on room/water temperature or presence detection, and more.
...
This controller is primarily intended for use in indoor gardens or aquariums with LED power supplies, but it can also be used for home decor lighting. The widespread use of LED lighting in home gardens, aquariums, and decor lighting presents many opportunities for this controller. From DIY hobbyist grow/reef lighting to off-the-shelf lighting, this controller is a cost-effective upgrade that can be used with many existing systems.
