...
## Background
The control of LED grow and aquarium lights is often limited to dimming knobs, controllers, or other proprietary solutions offered by manufacturers or resellers. However, by building your own, cost-effective dimming controller, you can unleash a whole new level of functionality, automation, and customization. With Home Assistant, the possibilities are limited only by your imagination. From creating custom lighting profiles for different growth stages or times of day to adjusting light output based on room/water temperature, presence detection, and more.
