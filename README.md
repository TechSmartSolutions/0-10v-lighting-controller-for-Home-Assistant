# 0-10v PWM LED Dimming Controller (includes code and setup for use with Home Assistant)
...
- 2x [joinable 400 Pin breadboards](https://www.google.com/search?q=joinable+400+Pin+breadboard) with removable power rails
